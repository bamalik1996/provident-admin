                        ...
                        <div class="wrap">
                            ...
                            <div class="manage-menus">
                                <form method="get" action="{{ $currentUrl }}"
                                    class="d-flex flex-wrap align-content-center align-items-center">
                                    ...
                                    {{-- <span class="add-new-menu-action  mt-2"> or <a
                                                                ...
                                                                <div class="customlinkdiv" id="customlinkdiv">
                                                                    <p id="menu-item-url-wrap">
                                                                        <label class="howto w-100"
                                                                            ...
                                                                            <input id="custom-menu-item-url"
                                                                                name="url" type="text"
                                                                                class="menu-item-textbox form-control "
                                                                                placeholder="url">
                                                                        </label>
                                                                    </p>
                                                                    ...
                                                                    <p id="menu-item-name-wrap">
                                                                        <label class="howto w-100"
                                                                            ...
                                                                            <input id="custom-menu-item-name"
                                                                                ...
                                                                                class="regular-text menu-item-textbox form-control input-with-default-title"
                                                                                title="Label menu">
                                                                        </label>
                                                                    </p>
                                                                    ...
                                                                    <p class="btn-controls">
                                                                        ...
                                                                        <a href="#" onclick="addcustommenu()"
                                                                            class="btn btn-secondary submit-add-to-menu right">Add
                                                                            menu item</a>
                                                    ...
                                                    <div class="major-publishing-actions">
                                                        <label class="menu-name-label howto open-label" for="menu-name">
                                                            ...
                                                            <input name="menu-name" id="menu-name" type="text"
                                                                class="menu-name regular-text menu-item-textbox form-control"
                                                        ...
                                                        @if (request()->has('action'))
                                                            {{-- <div class="publishing-action">
                                                                <a onclick="createnewmenu()" name="save_menu"
                                                                    id="save_menu_header"
                                                                    class="btn btn-primary menu-save">Create menu</a>
                                                            </div> --}}
                                                        @elseif(request()->has('menu'))
                                                            <div class="publishing-action">
                                                                <a onclick="getmenus()" name="save_menu"
                                                                    id="save_menu_header"
                                                                    class="btn btn-primary menu-save">Save menu</a>
                                                                    ...
                                                                    <li id="menu-item-{{ $m->id }}"
                                                                        ...
                                                                        <div class="menu-item-settings"
                                                                            ...
                                                                            <input type="hidden"
                                                                                ...
                                                                                value="{{ $m->id }}" />
                                                                            <p
                                                                                class="description description-thin w-100">
                                                                                <label
                                                                            ...
                                                                            <p
                                                                                class="field-css-classes description description-thin w-100">
                                                                                <label
                                                                                    for="edit-menu-item-classes-{{ $m->id }}"
                                                                                    class="w-100"> Class CSS
                                                                                    (optional)
                                                                                    <br>
                                                                                    <input type="text"
                                                                                        id="clases_menu_{{ $m->id }}"
                                                                                        class="widefat code edit-menu-item-classes  form-control"
                                                                            ...
                                                                            <p
                                                                                class="field-css-url description description-wide w-100">
                                                                                <label
                                                                                    ...
                                                                                    <input type="text"
                                                                                        id="url_menu_{{ $m->id }}"
                                                                                        class="widefat code edit-menu-item-url  form-control"
                                                                                        id="url_menu_{{ $m->id }}"
                                                                                        value="{{ $m->link }}">
                                                                                </label>
                                                                            </p>
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <a class="item-delete submitdelete deletion btn btn-danger mx-1"
                                                                                    id="delete-{{ $m->id }}"
                                                                                    href="{{ $currentUrl }}?action=delete-menu-item&menu-item={{ $m->id }}&_wpnonce=2844002501">Delete</a>
                                                                                <a class="item-cancel submitcancel hide-if-no-js btn btn-secondary"
                                                                                    id="cancel-{{ $m->id }}"
