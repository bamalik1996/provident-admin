...
namespace App\Library\Menu\src\Models;
...
class MenuItems extends Model
{
    ...
    {
        return $this->belongsTo('App\Library\Menu\src\Models\Menus', 'menu');
    }

    public function child()
    {
        return $this->hasMany('App\Library\Menu\src\Models\MenuItems', 'parent')->orderBy('sort', 'ASC');
    }
}
