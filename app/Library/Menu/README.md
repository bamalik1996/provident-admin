...
```php
App\Library\Menu\MenuServiceProvider::class,
```

3. add facade in the file config/app.php (optional on laravel 5.5)

```php
'Menu' => App\Library\Menu\Facades\Menu::class,
```

4. Run publish

```php
php artisan vendor:publish --provider="App\Library\Menu\MenuServiceProvider"
```
...
```php
use App\Library\Menu\Models\Menus;
use App\Library\Menu\Models\MenuItems;
...
```php
use App\Library\Menu\Facades\Menu;
...
/*
Parameter: Menu ID
Return: Array
