					...
					<div id="wpbody-content">
						...
						<div class="wrap">
							...
							<div class="manage-menus">
								<form method="get" action="{{ $currentUrl }}" class="d-flex flex-wrap align-content-center align-items-center">
									<label for="menu" class="selected-menu">Select the menu you want to edit:</label>

									{!! Menu::select('menu', $menulist) !!}

									<span class="submit-btn mt-2">
										<input type="submit" class="btn btn-secondary" value="Choose">
									</span>
									{{-- <span class="add-new-menu-action  mt-2"> or <a href="{{ $currentUrl }}?action=edit&menu=0">Create new menu</a>. </span> --}}
								</form>
							</div>
														...
														<div class="inside">
															<div class="customlinkdiv" id="customlinkdiv">
																<p id="menu-item-url-wrap">
																	<label class="howto w-100" for="custom-menu-item-url"> <span>URL*</span>&nbsp;&nbsp;&nbsp;
																		<input id="custom-menu-item-url" name="url" type="text" class="menu-item-textbox form-control " placeholder="Enter URL">
																	</label>
																</p>

																<p id="menu-item-name-wrap">
																	<label class="howto w-100" for="custom-menu-item-name"> <span>Label*</span>&nbsp;
																		<input id="custom-menu-item-name" name="label" type="text" class="regular-text menu-item-textbox form-control input-with-default-title" placeholder="Enter Label">
																	</label>
																</p>
																...
																<p class="btn-controls">
                                                                    @can('menu.create')
																	   <input type="button"  href="#" onclick="addcustommenu()"  class="btn btn-secondary submit-add-to-menu right" value="Add menu item" >
                                                                    @endcan
												...
												<div id="nav-menu-header">
													{{-- <div class="major-publishing-actions"> --}}
														{{-- <label class="menu-name-label howto open-label" for="menu-name"> <span>Name</span> --}}
															<input name="menu-name" id="menu-name" type="hidden" class="menu-name regular-text menu-item-textbox form-control" title="Enter menu name" value="@if(isset($indmenu)){{$indmenu->name}}@endif">
														...
														<ul class="menu ui-sortable" id="menu-to-edit">
															...
															<li id="menu-item-{{$m->id}}" class="menu-item menu-item-depth-{{$m->depth}} menu-item-page menu-item-edit-inactive pending" style="display: list-item;">
																...
																<div class="menu-item-settings" id="menu-item-settings-{{$m->id}}">
																	...
																	<p class="description description-thin w-100 label">
																		<label for="edit-menu-item-title-{{$m->id}}" class="w-100"> Label*
																			<br>
																	...
																	<p class="field-css-classes description description-thin w-100">
																		{{-- <label for="edit-menu-item-classes-{{$m->id}}" class="w-100"> Class CSS (optional) --}}
																			{{-- <br> --}}
																			<input type="hidden" id="clases_menu_{{$m->id}}" class="widefat code edit-menu-item-classes  form-control" name="clases_menu_{{$m->id}}" value="{{$m->class}}">
																		{{-- </label> --}}
																	</p>

																	<p class="field-css-url description description-wide w-100 url">
																	...
																	<div class="menu-item-actions description-wide submitbox">
                                                                        @can('menu.delete')
																		   <a class="item-delete submitdelete deletion btn btn-danger mx-1" id="delete-{{$m->id}}" href="{{ $currentUrl }}?action=delete-menu-item&menu-item={{$m->id}}&_wpnonce=2844002501">Delete</a>
                                                                        @endcan
																		{{-- <a class="item-cancel submitcancel hide-if-no-js btn btn-secondary" id="cancel-{{$m->id}}" href="{{ $currentUrl }}?edit-menu-item={{$m->id}}&cancel=1424297719#menu-item-settings-{{$m->id}}">Cancel</a> --}}
																		@can('menu.edit')
                                                                           <a onclick="getmenus(this)" class="btn btn-primary updatemenu" id="update-{{$m->id}}" href="javascript:void(0)">Update item</a>
                                                                        @endcan
