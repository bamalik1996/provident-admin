        ...
        <div class="card-body">
            <div class="d-lg-flex align-items-center mb-4 gap-3">
                ...
                @can(request()->segment(1).'.export')
                    <div class="ms-auto">
                        <a href="{{ route(request()->segment(1).'.export') }}" class="btn btn-primary mt-2 mt-lg-0">
                            Export {{ ucwords(str_replace('_', ' ', request()->segment(1))) }}
                        </a>
                    </div>
                @endcan
            </div>
                ...
                <table class="table mb-0">
                    ...
                    <tbody>
                        @foreach ($models as $information)
                            <tr>
                                <td>
                                    {{ getValue($information,'name') }}
                                </td>
                                <td>
                                    {{ getValue($information,'email') }}
                                </td>
                                <td>
                                    {{ getValue($information,'phone_number') }}
                                </td>
                                <td>
                                    {{ getValue($information,'message') }}
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
